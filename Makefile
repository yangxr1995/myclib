...
test:src/main.o src/com_msg.o src/event.o src/thread_pool.o src/mm_pool.o  src/args.o src/logger.o ./src/assert.o ./src/table.o ./src/mcslock.o src/arr.o src/memchk.o src/mm_pool.o src/timer_wheel.o
